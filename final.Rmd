...
Social support, corruption and generosity are statistically significant and they are all positively correlated with high freedom. Compared to last linear regression model the variables get 20-28 times higher correlation with high freedom. Corruption has the highest estimate of 11,62. In countries where freedom is perceived higher, social support, corruption and generosity are important explainers.

The odds ratios seem to be large. If there is social support, a person is 3.22+01 or 32,24 times likely to have a perception of high freedom compared to if there was no social support. But if there was a perception of no corruption, a person would be 111 768 times likely to have a perception of high freedom than without. Is this right, is there any point in these numbers anymore? *CONF INT POIS?
...
PALJON VAIHTELUA SOCIAL SUPPORTISSA ? looginen ?

menetelmien yhdistäminen
lda/pca/mca + regressio
