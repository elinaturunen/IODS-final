...
Script here: <https://github.com/elinaturunen/IODS-final/blob/208cf4a26fded4376963e0408da2fa13527487d1/final.R>
...
I suppose linear multiple regression is suitable method for the question, when examining correlations of variables and the dependent variable is continuous.
...
PCA seems to be working well compared to previous knowledge of the data. Linear discriminant analysis, k-means clustering and multiple correspondence analysis are other methods for finding essential divisions in data and closely related to each other. K-means can be used to find clusters, not essential variables in the same way. LDA can be used to finding variables that separate classes best and the target needs to be categorical, which was not the purpose here. MCA can be used to find structure or important dimensions, like PCA, for categorical variables.
